...
I selected this code because despite the fact that it does not work completly as intentionally as I wanted, it still creates an agreeable output. I am also the most proud of the flexiblity of the code, because of the use of varibles the output can be changed with relitive ease, and comments make the code eaily readable to editors.
